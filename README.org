...
to check if your favorite terminal emulator is on the list. If you predominately
run Emacs in GUI (X-Windows, macOS, Windows) frames you don't need Clipetty.
