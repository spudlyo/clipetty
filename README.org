...
#+END_EXPORT
Clipetty is an minor mode for terminal (TTY) Emacs users that sends text that
you kill in Emacs to your Operating System's clipboard.
...
If you predominately use Emacs in GUI (X-Windows, macOS, Windows) frames you
don't need Clipetty.
